extension Mongo
{
    ...
    {
        /// A command was timed-out by the driver. If `sent` is false, then
        /// the command was never sent over the wire in the first place,
        /// because the deadline for the command had already passed.
        ///
