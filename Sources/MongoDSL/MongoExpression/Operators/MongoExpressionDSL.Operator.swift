...
extension MongoExpressionDSL.Operator:BSONDSL
{
    @inlinable public
    var bytes:[UInt8]
    {
...
{
    @inlinable public
    subscript(key:Filter) -> MongoExpressionDSL.Filter?
    {
        get
        {
            nil
    ...
    @inlinable public
    subscript(key:Map) -> MongoExpressionDSL.Map?
    {
        get
        {
            nil
    ...
    @inlinable public
    subscript(key:Reduce) -> MongoExpressionDSL.Reduce?
    {
        get
        {
            nil
