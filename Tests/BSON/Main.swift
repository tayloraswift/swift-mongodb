...
enum Main:SyncTests
{
    ...
    func run(tests:inout Tests)
    {
        ...
        tests.group("max")
        {
            $0.test(case: BSONTest.init(name: "max",
        ...
        tests.group("min")
        {
            $0.test(case: BSONTest.init(name: "min",
        ...
        tests.group("null")
        {
            $0.test(case: BSONTest.init(name: "null",
                canonical: "080000000A610000",
                expected: ["a": .null]))
            
            $0.test(case: BSONTest.init(name: "undefined",
        ...
        tests.group("bool")
        {
            $0.test(case: BSONTest.init(name: "true",
                canonical: "090000000862000100",
                expected: ["b": true]))
            $0.test(case: BSONTest.init(name: "false",
                canonical: "090000000862000000",
                expected: ["b": false]))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-subtype",
                    invalid: "090000000862000200"),
                    expecting: BSON.BooleanSubtypeError.init(invalid: 2))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-subtype-negative",
                    invalid: "09000000086200FF00"),
                    expecting: BSON.BooleanSubtypeError.init(invalid: 255))
        }
        ...
        tests.group("int32")
        {
            ...
            $0.test(case: BSONTest.init(name: "-1",
                canonical: "0C000000106900FFFFFFFF00",
                expected: ["i": .int32(-1)]))
            
            $0.test(case: BSONTest.init(name: "0",
            ...
            $0.test(case: InvalidBSONTest.init(name: "truncated",
                    invalid: "09000000_10_6100_05_00"),
                    expecting: BSON.InputError.init(expected: .bytes(4), encountered: 1))
        }
        ...
        tests.group("uint64")
        {
            ...
            $0.test(case: InvalidBSONTest.init(name: "truncated",
                    ...
                    expecting: BSON.InputError.init(expected: .bytes(8), encountered: 7))
        }
            
        // https://github.com/mongodb/specifications/blob/master/source/bson-corpus/tests/top.json
        tests.group("top")
        {
            $0.test(case: BSONTest.init(name: "dollar-prefixed-key",
                canonical: "0F00000010246B6579002A00000000",
                expected: ["$key": .int32(42)]))
            
            $0.test(case: BSONTest.init(name: "dollar-key",
                canonical: "0E00000002240002000000610000",
                expected: ["$": "a"]))
            
            $0.test(case: BSONTest.init(name: "dotted-key",
                canonical: "1000000002612E620002000000630000",
                expected: ["a.b": "c"]))
            
            $0.test(case: BSONTest.init(name: "dot-key",
                canonical: "0E000000022E0002000000610000",
                expected: [".": "a"]))
            
            $0.test(case: BSONTest.init(name: "empty-truncated-header",
                degenerate: "0100000000",
                canonical: "0500000000",
                expected: [:]))
            
            $0.test(case: BSONTest.init(name: "empty",
                canonical: "0500000000",
                expected: [:]))
            
            $0.test(case: BSONTest.init(name: "invalid-end-of-object-0x01",
                degenerate: "05000000_01",
                canonical: "05000000_00",
                expected: [:]))
            
            $0.test(case: BSONTest.init(name: "invalid-end-of-object-0xff",
                degenerate: "05000000_FF",
                canonical: "05000000_00",
                expected: [:]))
            
            $0.test(case: BSONTest.init(name: "invalid-end-of-object-0x70",
                degenerate: "05000000_70",
                canonical: "05000000_00",
                expected: [:]))
            
            $0.test(case: InvalidBSONTest.init(name: "zeroes",
                    invalid: "00000000_000000000000"),
                    //        ^~~~~~~~
                    expecting: BSON.HeaderError<BSON.DocumentFrame>.init(length: 0))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-length-over",
                    invalid: "12000000_02_666F6F00_04000000_626172"),
                    //        ^~~~~~~~
                    expecting: BSON.InputError.init(expected: .bytes(0x12 - 4), encountered: 12))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-length-under",
                    invalid: "12000000_02_666F6F00_04000000_62617200_00_DEADBEEF"),
                    //        ^~~~~~~~
                    expecting: BSON.InputError.init(expected: .end, encountered: 4))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-type-0x00",
                    invalid: "07000000_00_0000"),
                    //                 ^~
                    expecting: BSON.TypeError.init(invalid: 0x00))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-type-0x80",
                    invalid: "07000000_80_0000"),
                    //                 ^~
                    expecting: BSON.TypeError.init(invalid: 0x80))
            
            $0.test(case: InvalidBSONTest.init(name: "truncated",
                    invalid: "12000000_02_666F"),
                    expecting: BSON.InputError.init(expected: .bytes(0x12 - 4), encountered: 3))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-key",
        ...
        {
            $0.test(case: BSONTest.init(name: "positive-quiet-nan",
            ...
            $0.test(case: BSONTest.init(name: "largest",
        ...
        tests.group("double")
        {
            $0.test(case: BSONTest.init(name: "+1.0",
            ...
            $0.test(case: BSONTest.init(name: "+1.0001220703125",
            ...
            $0.test(case: BSONTest.init(name: "1.2345678921232E+18",
            ...
            $0.test(case: InvalidBSONTest.init(name: "truncated",
                    ...
                    //        ^~~~~~~~
                    expecting: BSON.InputError.init(expected: .end, encountered: 1))
        }
        ...
        tests.group("id")
        {
            ...
            $0.test(case: BSONTest.init(name: "zeroes",
            ...
            $0.test(case: BSONTest.init(name: "random",
            ...
            $0.test(case: InvalidBSONTest.init(name: "truncated",
                    ...
                    //        ^~~~~~~~
                    expecting: BSON.InputError.init(expected: .bytes(0x12 - 4), encountered: 13))
        }

        // https://github.com/mongodb/specifications/blob/master/source/bson-corpus/tests/dbpointer.json
        tests.group("pointer")
        {
            $0.test(case: BSONTest.init(name: "ascii",
        ...
        tests.group("binary")
        {
            ...
            $0.test(case: InvalidBSONTest.init(name: "invalid-length-over",
                    ...
                    //                         ^~~~~~~~
                    expecting: BSON.InputError.init(expected: .bytes(0xFF + 1), encountered: 17))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-length-negative",
                    invalid: "0D000000057800FFFFFFFF0000"),
                    expecting: BSON.InputError.init(expected: .bytes(1)))
        ...
        tests.group("document")
        {
            ...
            $0.test(case: BSONTest.init(name: "empty-key",
                canonical: "150000000378000D00000002000200000062000000",
                expected: ["x": ["": "b"]]))
            
            $0.test(case: BSONTest.init(name: "single-character-key",
            ...
            $0.test(case: InvalidBSONTest.init(name: "invalid-length-over",
                    ...
                    //                             ^~~~~~~~
                    expecting: BSON.InputError.init(expected: .bytes(0x0F - 4), encountered: 10))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-length-under",
                    invalid: "15000000_03_666F6F00_0A000000_08_62617200_01_00_00"),
                    //                                                     ^~
                    expecting: BSON.TypeError.init(invalid: 0))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-value",
                    invalid: "1C000000_03_666F6F00_12000000_02_62617200_05000000_62617A000000"),
                    //                                                  ^~~~~~~~
                    expecting: BSON.InputError.init(expected: .bytes(5), encountered: 4))
        ...
        tests.group("tuple")
        {
            $0.test(case: BSONTest.init(name: "empty",
                ...
                expected: ["a": []]))
            $0.test(case: BSONTest.init(name: "single-element",
                canonical: "140000000461000C0000001030000A0000000000", 
                expected: ["a": [.int32(10)]]))
            
            $0.test(case: BSONTest.init(name: "single-element-empty-key",
                degenerate: "130000000461000B00000010000A0000000000", 
                canonical: "140000000461000C0000001030000A0000000000", 
                expected: ["a": [.int32(10)]]))
            
            $0.test(case: BSONTest.init(name: "single-element-invalid-key",
                degenerate: "150000000461000D000000106162000A0000000000", 
                canonical: "140000000461000C0000001030000A0000000000", 
                expected: ["a": [.int32(10)]]))
            
            $0.test(case: BSONTest.init(name: "multiple-element-duplicate-keys",
            ...
            $0.test(case: InvalidBSONTest.init(name: "invalid-length-over",
                    ...
                    //                         ^~~~~~~~
                    expecting: BSON.InputError.init(expected: .bytes(0x0D - 4), encountered: 8))
            ...
            $0.test(case: InvalidBSONTest.init(name: "invalid-element",
        ...
        tests.group("regex")
        {
            ...
            $0.test(case: BSONTest.init(name: "escaped",
                canonical: "100000000B610061625C226162000000",
                expected: ["a": .regex(.init(pattern: #"ab\"ab"#, options: []))]))
            
            // note: frameshift
            $0.test(case: InvalidBSONTest.init(name: "invalid-pattern",
                    invalid: "0F0000000B610061006300696D0000"),
                    expecting: BSON.Regex.OptionError.init(invalid: "c"))
            // note: frameshift
            $0.test(case: InvalidBSONTest.init(name: "invalid-options",
                    invalid: "100000000B61006162630069006D0000"),
                    expecting: BSON.TypeError.init(invalid: 109))
        }
        ...
        tests.group("string")
        {
            ...
            $0.test(case: InvalidBSONTest.init(name: "missing-trailing-null-byte",
            ...
            $0.test(case: InvalidBSONTest.init(name: "invalid-length-over-document",
                    invalid: "12000000_02_00_FFFFFF00_666F6F6261720000"),
                    //                       ^~~~~~~~
                    expecting: BSON.InputError.init(expected: .bytes(0xffffff), encountered: 7))
            ...
            $0.test(case: BSONTest.init(name: "invalid-utf-8",
        ...
        tests.group("javascript-scope")
        {
            ...
            // frameshift error.
            $0.test(case: InvalidBSONTest.init(name: "invalid-length-frameshift-clips-scope",
                    invalid: "28000000_0F_6100_20000000_04000000_61626364_00130000_0010780001000000107900010000000000"),
                    //                                                    ^~~~~~~~
                    expecting: BSON.InputError.init(expected: .bytes(0x00_00_13_00 - 4), encountered: 16))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-length-over",
                    invalid: "28000000_0F_6100_20000000_06000000_616263640013_00000010_780001000000107900010000000000"),
                    //                                                        ^~~~~~~~
                    expecting: BSON.InputError.init(expected: .bytes(0x10_00_00_00 - 4), encountered: 14))
            // note: frameshift
            $0.test(case: InvalidBSONTest.init(name: "invalid-length-frameshift",
                    invalid: "28000000_0F_6100_20000000_FF000000_61626364001300000010780001000000107900010000000000"),
                    expecting: BSON.InputError.init(expected: .bytes(255), encountered: 24))
            
            $0.test(case: InvalidBSONTest.init(name: "invalid-scope",
